...
export class MajorListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['major','buttons'];
  displayedColumnsName: string[] = ['Major'];
  AllElement: MatTableDataSource<majormodels>;

  constructor(private snackBar: MatSnackBar, private isService: MajorService, public dialog: MatDialog,
