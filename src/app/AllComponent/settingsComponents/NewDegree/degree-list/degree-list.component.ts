...
export class DegreeListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['degree','buttons'];
  displayedColumnsName: string[] = ['Degree'];
  AllElement: MatTableDataSource<degreemodels>;

  constructor(private snackBar: MatSnackBar, private isService: DegreeService, public dialog: MatDialog,
